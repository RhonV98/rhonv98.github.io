...
function getTaskByName() {
  console.log("Called getTaskByName");

  let taskName = document.getElementById("searchTasks").value;

  console.log("TaskId:" + taskName);
  let taskURL = "http://localhost:4000/task?taskName=" + taskName;
  const fetchPromise = fetch(taskURL);
  ...
  fetchPromise
    ...
    .then((task) => {
      ...
      document.getElementById("searchTasksContent").innerHTML = message;
    })
    .catch((err) => {
      console.log(err);
      document.getElementById("searchTasksContent").innerHTML = "Invalid task id: " + taskName;
    });
